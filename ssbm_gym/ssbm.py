...
class SimpleController(object):
    def __init__(self, button=SimpleButton.NONE, stick=neutral_stick, duration=None):
        self.button = button
        self.stick = stick
...
#jc_chain = [SimpleController(button=SimpleButton.Y, duration=1), SimpleController(button=SimpleButton.Z)]
#
## better sh that also allows jc grab and upsmash at act_every 3
#sh2_chain = [
#    SimpleController(duration=2),
#    SimpleController(button=SimpleButton.Y),
#]
#
#fox_wd_chain_left = [
#    SimpleController(button=SimpleButton.Y, duration=3),
#    SimpleController(button=SimpleButton.L, stick=Stick.polar(-7/8 * math.pi))
#]
#
#wd_left = SimpleController(button=SimpleButton.L, stick=Stick.polar(-7/8 * math.pi))
